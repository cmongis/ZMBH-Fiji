...
@Plugin(type = Command.class, menuPath = "Dev-commands>CMD Get measurements (all slices)", label="")
public class MakeMeasurementsCommand_AllSlices implements Command {
    ...
    public void run() {
        ...
        try {
            ...
            promise = commandService.run(SlideCorrectCommand_DarkField_FlatField_AllSlices.class, true, "inputDataset", inputStackDataset, "darkfieldValue", darkfieldValue, "mCherryFlatFieldFile", mCherryFlatFieldFile, "gfpFlatFieldFile", gfpFlatFieldFile, "bfpFlatFieldFile", bfpFlatFieldFile);
            promiseContent = promise.get();
