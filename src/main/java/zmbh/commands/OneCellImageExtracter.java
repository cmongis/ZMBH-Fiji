...
@Plugin(type = Command.class, menuPath = "Dev-commands>CMD One Cell Image Extracter", label="")
    ...
    public void run() {
        try {
            ...
            for (CSVRecord record : records) {
                ...
                cellRecordList.add(new MyCellRecord(index, X, Y, imageFile));
            ...
            for(String imagefile : imagelabelSet){                          
                ...
                List<MyCellRecord> currentCellRecordList  = new ArrayList<>();
                ...
                for(MyCellRecord record : currentCellRecordList){
