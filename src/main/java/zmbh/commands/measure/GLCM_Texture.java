...
public class GLCM_Texture implements PlugInFilter {
    ...
    public void run(ImageProcessor ip) {
        ...
        // This part get all the pixel values into the pixel [ ] array via the Image Processor
	...
	if (selectedStep.equals("0 degrees")){
        ...
        if (doIcalculateASM==true){
            ...
            //System.out.println("ASM " + row + " " + asm);
        }
        ...
        if (doIcalculateContrast==true){
            ...
            //System.out.println("CONTRAST " + row + " " + contrast);
        }
		...
		for (b=0; b<257;b++) {
            ...
            //System.out.println("Correlation " + row + " " + correlation);
	}
        ...
        if (doIcalculateIDM==true){
            ...
            //System.out.println("Inverse Difference Moment    " + row + " " + IDM);
        }
        ...
        if (doIcalculateEntropy==true){
            ...
            //System.out.println("Entropy  " + row + " " + entropy);
        }
