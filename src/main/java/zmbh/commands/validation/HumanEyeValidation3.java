        ...
        try {
            ...
            */
            for(int i = 0; i < cellRecordList.size(); i++){
                ...
                CellRecord record = cellRecordList.get(i);
                ...
                CellXseed seed = cellxSeedList.get(i);
                
                //for(CellXseed cellxSeed : cellxSeedList){
                    long startTime = System.nanoTime();
                    
                    
                    promise = commandService.run(ConvertPixelIndexToPoint.class, false, "imgHeigth", (int) dataset.dimension(1), "perimeterPixelListIndex", seed.getPerimeterPixelListIndex());
                    promiseContent = promise.get();
